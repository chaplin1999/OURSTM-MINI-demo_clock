...
//			LCD_SetWindow(0,100,200,200);for (u32 j=0;j<10000;j++) LCD_GetPixel(); // 2860000pps(0.572x)
...
//			LCD_FillRectangle_RGB565(0, 14, 240, 320-14, C_RGB565(0xff, 0x22, 0x66)); // 166fps/12191040pps(1x)
//			LCD_FillRectangle_RGB4444(0, 14, 240, 320-14, 0xf263); // 30fps/2203200pps(0.18x)
//			LCD_FillCircle_RGB565(120, 120, 119, C_RGB565(0xff, 0x22, 0x66)); // 80fps/4569680pps(0.375x)
...
//			Painter_DrawLine(50, 50, 200, 250, 0xf262, 30, 0); // 90fps,720000pps
...
//			Painter_DrawPoly(poly_x, poly_y, 30, 0x6fc1, 1, 0); // 11fps(x1)
...
//			Painter_PutImage(res_img_res_lp_jpg,0,10,0x2f); //22fps, 1689600pps(x0.139)
...
//			Painter_PutString(text, 24, 0xfffe, 0x888e, 0, 14, 240, 320, PAINTER_STR_SHADOW*2); // 10fps
//			Painter_PutString(text, 24, 0xfffe, 0x888e, 0, 14, 240, 320, PAINTER_STR_SFLUSH | PAINTER_STR_SHADOW*2); // 10fps
